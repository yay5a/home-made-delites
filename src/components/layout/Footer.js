...
export default function Footer() {
	...
	return (
		<footer className='bg-gray-800 dark:bg-gray-900 text-white'>
			...
			{shouldShowQuota() && (
				<div className='border-b border-gray-700 dark:border-gray-600 py-3'>
						...
						<div className='flex items-center justify-between'>
							...
							{isAdmin && (
								<Link
									...
									className='text-sm text-blue-300 hover:text-blue-100 dark:text-blue-400 dark:hover:text-blue-200'>
									View API Dashboard
								</Link>
							)}
						</div>
